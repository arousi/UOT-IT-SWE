...
class FirstNameField extends StatelessWidget {
  ...
  const FirstNameField({required this.controller, required this.focusNode});
...
class LastNameField extends StatelessWidget {
  ...
  const LastNameField({required this.controller, required this.focusNode});
...
class PasswordField extends StatelessWidget {
  ...
  const PasswordField({required this.controller, required this.focusNode});
